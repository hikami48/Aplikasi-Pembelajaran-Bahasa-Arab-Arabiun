...
class GantiKarakterPages extends StatefulWidget {
  GantiKarakterPages({Key? key, required this.from}) : super(key: key);

  String from;

  @override
  _GantiKarakterPagesState createState() => _GantiKarakterPagesState();
}

class _GantiKarakterPagesState extends State<GantiKarakterPages> {
