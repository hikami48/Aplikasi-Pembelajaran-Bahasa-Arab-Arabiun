...
class _GlosariumBendaState extends State<GlosariumBenda> {
  ...
  Widget build(BuildContext context) {
    final Stream<QuerySnapshot> usersStream = firestore
        ...
        .orderBy('id') //sorting
        .snapshots(); // ngambil koleksi list
        ...
        children: [
          ...
          StreamBuilder<QuerySnapshot>(
            ...
            builder:
              ...
              return GridView.builder(//ngatur grid
                  ...
                  return GestureDetector(
                    onTap: () async {
                      await firestore
                          ...
                          .doc(auth.currentUser!.uid)
                          .update({
                        'last_click': MateriKataBenda.listMateriKataBenda[0] // list ke 0
